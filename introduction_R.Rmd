...
## Connaître les caractéristiques des objets

**Classe/Type** des objets : fonction `class`

**noms des colonnes** des tableaux : fonction `colnames`

**Structure** des objets : fonction `str` 

**Dimensions**  des objets : fonction `dim`

**Nombre de lignes** d'un objet : fonction `nrow`

**Nombre de colonnes** d'un objet : fonction `ncol`

**Taille** d'un vecteur : fonction `length`
...
```{r rayshader, fig.height=3, cache  = TRUE}
library(rayshader)
...
#             text = "Moss Landing", textsize = 2, linewidth = 5, freetype = F)
#render_label(montereybay, x = 220, y = 70, z = 7000, zscale = 50,
#             text = "Santa Cruz", textcolor = "darkred", linecolor = "darkred",
#             textsize = 2, linewidth = 5, freetype = F)
#render_label(montereybay, x = 300, y = 270, z = 4000, zscale = 50,
#             text = "Monterey", dashed = TRUE, textsize = 2, linewidth = 5, freetype = F)
#render_label(montereybay, x = 50, y = 270, z = 1000, zscale = 50,  textcolor = "white", linecolor = "white", text = "Monterey Canyon", relativez = FALSE, textsize = 2, linewidth = 5, freetype = F) 
Sys.sleep(0.2)
render_snapshot(clear=TRUE)
```
