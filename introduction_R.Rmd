...
<span style="font-size:0.8em;"> les attributs peuvent être de longueur différentes,  un attribut peut lui même être une liste :  <span>
...
```{r ggplotdemo, echo=TRUE, warning=FALSE,cache=TRUE, message=FALSE}
library(ggplot2)
...
## cartography
```{r cartodemo, message=FALSE, fig.height=5, cache=TRUE}
library(sf)
library(cartography)
